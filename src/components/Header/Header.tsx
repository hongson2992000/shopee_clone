        ...
        <div className='flex justify-end'>
          ...
          {isAuthenticated && (
            <Popover
              ...
              renderPopover={
                <div className='relative rounded-sm border border-gray-200 bg-white px-2 shadow-md'>
                  <Link
                    to='/'
            ...
            >
              <div className='mr-2 h-6 w-6 flex-shrink-0'>
                <img
                  ...
                  src='https://down-vn.img.susercontent.com/file/d520e438f74460dee9590f940d86601b_tn'
                  alt=''
                />
              </div>
              <div>
